...
void saveToFile(char*, int [100], int);

void loadFromFile(char*, int [100], int*);

void fillArray(int [100], int, int, int);

void printArray(int [100], int);

void compArrays(int [100], int [100]);
# 11 "file.c" 2

int read_counter = 0;
int write_counter = 0;

void saveToFile(char* file_name, int array[100], int size)
{
...
void loadFromFile(char* file_name, int array[100], int* size)
{
...
void fillArray(int array[100], int size, int min, int max)
{
    srand(time(
# 61 "file.c" 3 4
              ((void *)0)
...
void compArrays(int arr1[100], int arr2[100])
{
    for(int i = 0; i < 100; i++)
    {
        if(arr1[i] != arr2[i])
