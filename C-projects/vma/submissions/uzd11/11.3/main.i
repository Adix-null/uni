...
int main()
{
    ...
    fillArray(m1, 100, 0, 73);
    fillArray(m2, 100, 0, 73);
    fillArray(m3, 100, 0, 73);

    saveToFile(file_name_1, m1, 100);
    saveToFile(file_name_1, m3, 100);
    loadFromFile(file_name_1, m1, &size);

    saveToFile(file_name_2, m2, 100);
